        ...
        <div className="p-8 max-w-7xl mx-auto">
          ...
          {activeView === 'search' && (
            <div className="space-y-8 animate-in fade-in duration-500">
              ...
              {/* Advanced Filters */}
              <div className="bg-[#111827]/50 border border-slate-800 rounded-2xl overflow-hidden max-w-5xl mx-auto transition-all shadow-xl">
                <button
                  ...
                  <div className="px-6 py-5 animate-in fade-in slide-in-from-top-2 duration-300 border-t border-slate-800/50">
                    <div className="flex flex-wrap items-start gap-8">
                      ...
                      <div className="space-y-2 min-w-[90px]">
                        <label className="text-[10px] font-bold tracking-widest text-slate-500 uppercase">Language</label>
                      ...
                      {/* Repository */}
                      <div className="space-y-2 min-w-[90px]">
                        <label className="text-[10px] font-bold tracking-widest text-slate-500 uppercase">Repository</label>
                        <div className="relative group/select">
                          <select
                            value={repo}
